...
class GUMP
{
        ...
        foreach ($fields as $field) {
            ...
            if (is_string($value)) {
                ...
                if (function_exists('iconv') && function_exists('mb_detect_encoding') && $utf8_encode) {
                    ...
                    if ('UTF-8' != $current_encoding && 'UTF-16' != $current_encoding) {
                ...
                foreach ($input_array as $value) {
                    ...
                    foreach ($rules as $rule) {
                        ...
                        if (is_callable([$this, $method])) {
                            ...
                            if (is_array($result)) {
                                if (false === array_search($result['field'], array_column($this->errors, 'field'))) {
                                    $this->errors[] = $result;
                                }
                            }
    ...
    protected function filter_ms_word_characters($value, $params = null)
    {
        ...
        return str_replace($word_ellipsis, $web_ellipsis, $value);
    }
    ...
    {
        if (isset($input[$field]) && (false === $input[$field] || 0 === $input[$field] || 0.0 === $input[$field] || '0' === $input[$field] || !empty($input[$field]))) {
            return;
        }
    ...
    protected function validate_alpha($field, $input, $param = null)
    {
        ...
        if (false !== !preg_match('/^([a-zÀÁÂÃÄÅÇÈÉÊËÌÍÎÏÒÓÔÕÖßÙÚÛÜÝàáâãäåçèéêëìíîïðòóôõöùúûüýÿ])+$/i', $input[$field])) {
            return [
                'field' => $field,
                'value' => $input[$field],
                'rule' => __FUNCTION__,
    ...
    protected function validate_alpha_numeric($field, $input, $param = null)
    {
        ...
        if (false !== !preg_match('/^([a-z0-9ÀÁÂÃÄÅÇÈÉÊËÌÍÎÏÒÓÔÕÖßÙÚÛÜÝàáâãäåçèéêëìíîïðòóôõöùúûüýÿ])+$/i', $input[$field])) {
            return [
                'field' => $field,
                'value' => $input[$field],
                'rule' => __FUNCTION__,
    ...
    protected function validate_alpha_dash($field, $input, $param = null)
    {
        ...
        if (false !== !preg_match('/^([a-zÀÁÂÃÄÅÇÈÉÊËÌÍÎÏÒÓÔÕÖßÙÚÛÜÝàáâãäåçèéêëìíîïðòóôõöùúûüýÿ_-])+$/i', $input[$field])) {
            return [
                'field' => $field,
                'value' => $input[$field],
                'rule' => __FUNCTION__,
    ...
    protected function validate_alpha_numeric_space($field, $input, $param = null)
    {
        ...
        if (false !== !preg_match('/^([a-z0-9ÀÁÂÃÄÅÇÈÉÊËÌÍÎÏÒÓÔÕÖßÙÚÛÜÝàáâãäåçèéêëìíîïðòóôõöùúûüýÿ\\s])+$/i', $input[$field])) {
            return [
                'field' => $field,
                'value' => $input[$field],
                'rule' => __FUNCTION__,
    ...
    protected function validate_alpha_space($field, $input, $param = null)
    {
        ...
        if (false !== !preg_match('/^([0-9a-zÀÁÂÃÄÅÇÈÉÊËÌÍÎÏÒÓÔÕÖßÙÚÛÜÝàáâãäåçèéêëìíîïðòóôõöùúûüýÿ\\s])+$/i', $input[$field])) {
            return [
                'field' => $field,
                'value' => $input[$field],
                'rule' => __FUNCTION__,
    ...
    protected function validate_integer($field, $input, $param = null)
    {
        ...
        if (false === filter_var($input[$field], FILTER_VALIDATE_INT)) {
            return [
                'field' => $field,
                'value' => $input[$field],
                'rule' => __FUNCTION__,
    ...
    {
        if (!isset($input[$field]) || empty($input[$field]) && 0 !== $input[$field]) {
            return;
        }
    ...
    protected function validate_float($field, $input, $param = null)
    {
        ...
        if (false === filter_var($input[$field], FILTER_VALIDATE_FLOAT)) {
            return [
                'field' => $field,
                'value' => $input[$field],
                'rule' => __FUNCTION__,
    ...
    protected function validate_url_exists($field, $input, $param = null)
    {
        ...
        if (function_exists('checkdnsrr') && function_exists('idn_to_ascii')) {
            if (false === checkdnsrr(idn_to_ascii($url), 'A')) {
                return [
                    'field' => $field,
                    'value' => $input[$field],
                    'rule' => __FUNCTION__,
    ...
    protected function validate_valid_ip($field, $input, $param = null)
    {
        ...
        if (false !== !filter_var($input[$field], FILTER_VALIDATE_IP)) {
            return [
                'field' => $field,
                'value' => $input[$field],
                'rule' => __FUNCTION__,
    ...
    protected function validate_valid_name($field, $input, $param = null)
    {
        ...
        if (false !== !preg_match("/^([a-z \\p{L} '-])+$/i", $input[$field])) {
            return [
                'field' => $field,
                'value' => $input[$field],
                'rule' => __FUNCTION__,
    ...
    protected function validate_date($field, $input, $param = null)
    {
        ...
        if (!$param) {
            ...
            if (false === $date || $input[$field] != date($param, $date->getTimestamp())) {
                return [
                    'field' => $field,
                    'value' => $input[$field],
                    'rule' => __FUNCTION__,
    ...
    protected function validate_required_file($field, $input, $param = null)
    {
        ...
        if (is_array($input[$field]) && 4 !== $input[$field]['error']) {
            return;
        }
    ...
    protected function validate_valid_persian_name($field, $input, $param = null)
    {
        ...
        if (false !== !preg_match('/^([ا آ أ إ ب پ ت ث ج چ ح خ د ذ ر ز ژ س ش ص ض ط ظ ع غ ف ق ک ك گ ل م ن و ؤ ه ة ی ي ئ ء ّ َ ِ ُ ً ٍ ٌ ْ\\x{200B}-\\x{200D}])+$/u', $input[$field])) {
            return [
                'field' => $field,
                'value' => $input[$field],
                'rule' => __FUNCTION__,
    ...
    protected function validate_valid_eng_per_pas_name($field, $input, $param = null)
    {
        ...
        if (false !== !preg_match("/^([A-Za-zÀÁÂÃÄÅÇÈÉÊËÌÍÎÏÒÓÔÕÖßÙÚÛÜÝàáâãäåçèéêëìíîïñðòóôõöùúûüýÿ'\\- ا آ أ إ ب پ ت ټ ث څ ج چ ح ځ خ د ډ ذ ر ړ ز ږ ژ س ش ښ ص ض ط ظ ع غ ف ق ک ګ ك گ ل م ن ڼ و ؤ ه ة ی ي ې ۍ ئ ؋ ء ّ َ ِ ُ ً ٍ ٌ ْ \\x{200B}-\\x{200D} \\s])+$/u", $input[$field])) {
            return [
                'field' => $field,
                'value' => $input[$field],
                'rule' => __FUNCTION__,
    ...
    protected function validate_valid_persian_digit($field, $input, $param = null)
    {
        ...
        if (false !== !preg_match('/^([۰۱۲۳۴۵۶۷۸۹٠١٢٣٤٥٦٧٨٩])+$/u', $input[$field])) {
            return [
                'field' => $field,
                'value' => $input[$field],
                'rule' => __FUNCTION__,
    ...
    protected function validate_valid_persian_text($field, $input, $param = null)
    {
        ...
        if (false !== !preg_match('/^([ا آ أ إ ب پ ت ث ج چ ح خ د ذ ر ز ژ س ش ص ض ط ظ ع غ ف ق ک ك گ ل م ن و ؤ ه ة ی ي ئ ء ّ َ ِ ُ ً ٍ ٌ \\. \\/ \\ = \\- \\| \\{ \\} \\[ \\] ؛ : « » ؟ > < \\+ \\( \\) \\* ، × ٪ ٫ ٬ ! ۰۱۲۳۴۵۶۷۸۹٠١٢٣٤٥٦٧٨٩\\x{200B}-\\x{200D} \\x{FEFF} \\x{22} \\x{27} \\x{60} \\x{B4} \\x{2018} \\x{2019} \\x{201C} \\x{201D} \\s])+$/u', $input[$field])) {
            return [
                'field' => $field,
                'value' => $input[$field],
                'rule' => __FUNCTION__,
    ...
    protected function validate_valid_pashtu_text($field, $input, $param = null)
    {
        ...
        if (false !== !preg_match('/^([ا آ أ ب پ ت ټ ث څ ج چ ح ځ خ د ډ ذ ر ړ ز ږ ژ س ش ښ ص ض ط ظ ع غ ف ق ک ګ ل م ن ڼ و ؤ ه ة ی ې ۍ ي ئ ء ْ ٌ ٍ ً ُ ِ َ ّ ؋ \\. \\/ \\ = \\- \\| \\{ \\} \\[ \\] ؛ : « » ؟ > < \\+ \\( \\) \\* ، × ٪ ٫ ٬ ! ۰۱۲۳۴۵۶۷۸۹٠١٢٣٤٥٦٧٨٩ \\x{200B}-\\x{200D} \\x{FEFF} \\x{22} \\x{27} \\x{60} \\x{B4} \\x{2018} \\x{2019} \\x{201C} \\x{201D} \\s])+$/u', $input[$field])) {
            return [
                'field' => $field,
                'value' => $input[$field],
                'rule' => __FUNCTION__,
